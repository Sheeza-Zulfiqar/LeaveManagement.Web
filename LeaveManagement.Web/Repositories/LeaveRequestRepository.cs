...
namespace LeaveManagement.Web.Repositories
{
    public class LeaveRequestRepository : GenericRepository<LeaveRequest>, ILeaveRequestRepository
    {
        ...
        {
            var leaveRequests = await context.LeaveRequest.Include(x=>x.LeaveType).ToListAsync();
        ...
        {
            return await context.LeaveRequest.Where(q => q.RequestingEmployeeId == employeeid)
        ...
        {
            var leaveRequest = await context.LeaveRequest.Include(x => x.LeaveType).FirstOrDefaultAsync(x=>x.Id==id);
